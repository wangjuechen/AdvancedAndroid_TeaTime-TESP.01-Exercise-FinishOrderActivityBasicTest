...
public class OrderActivityBasicTest {
    ...
    @Rule
    public ActivityTestRule<OrderActivity> activityActivityTestRule = new ActivityTestRule<OrderActivity>(OrderActivity.class);
    ...
    @Test
    public  void clickDecrementMethod_orderButton() {
